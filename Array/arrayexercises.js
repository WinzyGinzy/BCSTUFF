...
fourthArray.forEach((num) => reverseArray.unshift(num));
...
for (i = 0; i < sixthArray.length; i++) {
    if (
      ...
      console.log('sixthArray and seventhArray contain same elements');
    } else {
      console.log('sixthArray and seventhArray do not contain any same elements ');
    }
  }
...
for (i = 0; i < eighthArray.length; i++) {
    if (
      ...
      console.log('eighthArray and ninthArray contain same elements');
    } else {
      console.log('eighthArray and ninthArray do not contain any same elements ');
    }
  }
...
const deconstructedArray = tenthArray.flat(Infinity);
...
let expectedNames = ['ron', 'hermione', 'harry'];
...
peopleInfo.forEach((tagged) => {

if (tagged.includes('@')) {
        emails.push(tagged);
    } else if (tagged.includes('1')) {
        phones.push(tagged);
    } else {
        names.push(tagged);
    }
...
splitArray.forEach((el) => {
  el.includes('o') ? oDetector.push(1) : oDetector.push(0);
});
console.log(oDetector);